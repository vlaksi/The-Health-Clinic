   ...
   public class RoomsHistory
   {
      ...
      public System.Collections.Generic.List<Patient> Patient
      {
         ...
         set
         {
            ...
            if (value != null)
            {
               foreach (Model.Users.Patient oPatient in value)
                  AddPatient(oPatient);
            }
         }
      }
      ...
      public void AddPatient(Model.Users.Patient newPatient)
      {
         if (newPatient == null)
            return;
      ...
      public void RemovePatient(Model.Users.Patient oldPatient)
      {
         if (oldPatient == null)
            return;
         if (this.patient != null)
